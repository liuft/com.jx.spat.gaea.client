...
import com.jx.spat.gaea.client.utility.AutoResetEvent;
import com.jx.spat.gaea.client.utility.logger.ILog;
import com.jx.spat.gaea.client.utility.logger.LogFactory;
import com.jx.spat.gaea.protocol.exception.DataOverFlowException;
import com.jx.spat.gaea.protocol.exception.ProtocolException;
import com.jx.spat.gaea.protocol.exception.TimeoutException;
import com.jx.spat.gaea.protocol.sfp.v1.SFPStruct;
import com.jx.spat.gaea.protocol.utility.ByteConverter;
import com.jx.spat.gaea.protocol.utility.ProtocolConst;
...
public class CSocket {
    ...
    public byte[] receive(int sessionId, int queueLen) throws IOException, TimeoutException, Exception {
        ...
        /**
         * 不解为何要验证算出来的长度要对比直接的长度。更不解为何会不一致。待解－－－liuft
         */
//        if (len != data.length) {
